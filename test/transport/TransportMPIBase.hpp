...
protected:
  ...
  void allocateAndInitBuffers(void** send_buffer, void** recv_buffer,
                              size_t send_bytes, size_t recv_bytes);
  void preRegisterBuffers(void* send_buffer, void* recv_buffer,
                          size_t send_bytes, size_t recv_bytes,
                          void** send_reg_handle, void** recv_reg_handle);
  void cleanupBuffers(void* send_buffer, void* recv_buffer,
                      void* send_reg_handle, void* recv_reg_handle);
};
