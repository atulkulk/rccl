...
TEST(Rcclwrap, AllrcclSetP2pNetChunkSizeTests) {
  ...
  // Register GFX942 tests with appropriate environment variables
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX942_LargeRanks_Isolated",
          []() {
            // Test logic for GFX942 Large Ranks
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX942_BoundaryRank64_Isolated",
          []() {
            // Test logic for GFX942 Boundary Rank 64
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            // Expected: 1 << 19 = 524288 for ranks = 64 (boundary case)
            EXPECT_EQ(chunkSize, 1 << 19)
                << "GFX942 with ranks = 64 should set chunk size to 524288";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX942_BoundaryRank63_Isolated",
          []() {
            // Test logic for GFX942 Boundary Rank 63
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_SmallRanks_Isolated",
          []() {
            // Test logic for GFX950 Small Ranks
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_MediumRanks_Isolated",
          []() {
            // Test logic for GFX950 Medium Ranks
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            EXPECT_EQ(chunkSize, 1 << 18) << "GFX950 with 16 <= ranks < 32 "
                                             "should set chunk size to 262144";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_LargeRanks_Isolated",
          []() {
            // Test logic for GFX950 Large Ranks
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_BoundaryRank16_Isolated",
          []() {
            // Test logic for GFX950 Boundary Rank 16
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            // Expected: 1 << 18 = 262144 for ranks = 16 (boundary case)
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_BoundaryRank15_Isolated",
          []() {
            // Test logic for GFX950 Boundary Rank 15
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_BoundaryRank32_Isolated",
          []() {
            // Test logic for GFX950 Boundary Rank 32
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "GFX950_BoundaryRank31_Isolated",
          []() {
            // Test logic for GFX950 Boundary Rank 31
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "UnsupportedArch_GFX908_Isolated",
          []() {
            // Test logic for unsupported GFX908
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            EXPECT_EQ(chunkSize, RCCL_VALUE_INVALID)
                << "Unsupported architecture GFX908 should leave chunk size to "
                   "invalid";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "UnsupportedArch_GFX90A_Isolated",
          []() {
            // Test logic for unsupported GFX90A
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            // Expected: RCCL_VALUE_INVALID for unsupported architectures
            EXPECT_EQ(chunkSize, RCCL_VALUE_INVALID)
                << "Unsupported architecture GFX90A should leave chunk size to "
                   "invalid";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "EmptyArchString_Isolated",
          []() {
            // Test logic for empty arch string
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            // Expected: RCCL_VALUE_INVALID for empty architecture
            EXPECT_EQ(chunkSize, RCCL_VALUE_INVALID)
                << "Empty architecture string should leave chunk size to "
                   "invalid";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PartialArchMatch_Isolated",
          []() {
            // Test logic for partial arch match
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            CreateMockComm(mockComm, mockTopo, mockGpuNode, "gfx94",
                           32); // Partial match

            int chunkSize = RCCL_VALUE_UNSET;
            rcclSetP2pNetChunkSize(mockComm, chunkSize);

            // Expected: RCCL_VALUE_INVALID for partial architecture match
            EXPECT_EQ(chunkSize, RCCL_VALUE_INVALID)
                << "Partial architecture match should leave chunk size to "
                   "invalid";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "ZeroRanks_GFX942_Isolated",
          []() {
            // Test logic for zero ranks with GFX942
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            ...
            // Expected: 1 << 17 = 131072 for zero ranks
            EXPECT_EQ(chunkSize, 1 << 17)
                << "Zero ranks should leave chunk size to default";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "ZeroRanks_GFX950_Isolated",
          []() {
            // Test logic for zero ranks with GFX950
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "LargeRankValues_GFX950_Isolated",
          []() {
            // Test logic for large rank values with GFX950
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            CreateMockComm(mockComm, mockTopo, mockGpuNode, "gfx950", 1000);

            int chunkSize = RCCL_VALUE_UNSET;
            rcclSetP2pNetChunkSize(mockComm, chunkSize);

            // Expected: 1 << 19 = 524288 for large ranks (>= 32)
            EXPECT_EQ(chunkSize, 1 << 19)
                << "GFX950 with large ranks should set chunk size to 524288";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "CaseInsensitiveArch_Isolated",
          []() {
            // Test logic for case insensitive architecture
            ncclComm_t mockComm = nullptr;
            struct ncclTopoSystem mockTopo;
            struct ncclTopoNode mockGpuNode;
            CreateMockComm(mockComm, mockTopo, mockGpuNode, "GFX942",
                           32); // Uppercase

            int chunkSize = RCCL_VALUE_UNSET;
            rcclSetP2pNetChunkSize(mockComm, chunkSize);

            // Depending on implementation, this might be case sensitive
            // Expected behavior may vary - adjust based on actual
            // implementation For now, assume case sensitive (should not match)
            EXPECT_EQ(chunkSize, RCCL_VALUE_INVALID)
                << "Case sensitive architecture matching should leave chunk "
                   "size to invalid";
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          ...
          []() {
            ...
            // When environment variable is set, it should override the logic
            // The actual behavior depends on implementation
            // This test verifies the environment variable takes precedence
            EXPECT_NE(chunkSize, RCCL_VALUE_UNSET)
                << "Environment variable should override default logic";

            CleanupMockComm(mockComm);
          })
          .withEnvironment({{"NCCL_P2P_NET_CHUNKSIZE", "123456"},
                            {"NCCL_MAX_NCHANNELS", "1"},
                            {"NCCL_DEBUG", "TRACE"},
...
TEST(Rcclwrap, AllPxnTests) {
  std::unordered_map<std::string, std::string> baseEnv = {{"NCCL_DEBUG", "TRACE"}, {"NCCL_DEBUG_SUBSYS", "ALL"}};
  ...
  // Register PXN GFX942 tests
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX942_SmallRanks_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX942_SmallRanks due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX942 with small ranks");
            ...
            // Expected: 1 (PXN disabled) for ranks < 64
            EXPECT_EQ(pxnDisable, 1) << "GFX942 with ranks < 64 should disable "
                                        "PXN (set pxnDisable to 1)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX942 small ranks test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX942_LargeRanks_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX942_LargeRanks due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX942 with large ranks");
            ...
            // Expected: 0 (PXN enabled) for ranks >= 64
            EXPECT_EQ(pxnDisable, 0) << "GFX942 with ranks >= 64 should "
                                        "enable PXN (set pxnDisable to 0)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX942 large ranks test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX942_BoundaryRank64_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX942_BoundaryRank64 due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX942 with boundary rank 64");
            ...
            // Expected: 0 (PXN enabled) for ranks >= 64
            EXPECT_EQ(pxnDisable, 0) << "GFX942 with ranks = 64 should enable "
                                        "PXN (set pxnDisable to 0)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX942 boundary rank 64 test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX942_BoundaryRank63_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX942_BoundaryRank63 due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX942 with boundary rank 63");
            ...
            // Expected: 1 (PXN disabled) for ranks < 64
            EXPECT_EQ(pxnDisable, 1) << "GFX942 with ranks = 63 should disable "
                                        "PXN (set pxnDisable to 1)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX942 boundary rank 63 test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));

  // Register PXN GFX950 tests
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX950_SmallRanks_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX950_SmallRanks due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX950 with small ranks");
            ...
            // Expected: 1 (PXN disabled) for ranks < 32
            EXPECT_EQ(pxnDisable, 1) << "GFX950 with ranks < 32 should disable "
                                        "PXN (set pxnDisable to 1)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX950 small ranks test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX950_LargeRanks_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX950_LargeRanks due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX950 with large ranks");
            ...
            // Expected: 0 (PXN enabled) for ranks >= 32
            EXPECT_EQ(pxnDisable, 0) << "GFX950 with ranks >= 32 should "
                                        "enable PXN (set pxnDisable to 0)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX950 large ranks test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX950_BoundaryRank32_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX950_BoundaryRank32 due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX950 with boundary rank 32");
            ...
            // Expected: 0 (PXN enabled) for ranks >= 32
            EXPECT_EQ(pxnDisable, 0) << "GFX950 with ranks = 32 should enable "
                                        "PXN (set pxnDisable to 0)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX950 boundary rank 32 test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));
  ...
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_GFX950_BoundaryRank31_Isolated",
          []() {
            // Check if we should skip this test due to environment variable
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_GFX950_BoundaryRank31 due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for GFX950 with boundary rank 31");
            ...
            // Expected: 1 (PXN disabled) for ranks < 32
            EXPECT_EQ(pxnDisable, 1) << "GFX950 with ranks = 31 should disable "
                                        "PXN (set pxnDisable to 1)";

            INFO(NCCL_LOG_INFO,
                 "PXN GFX950 boundary rank 31 test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment(baseEnv));

  // Register unsupported architecture tests
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          ...
          []() {
            ...
            // being set
            if (ShouldSkipPxnTest()) {
              GTEST_SKIP() << "Skipping PXN_UnsupportedArch_GFX908 due to "
                              "environment variable being set";
              return;
            }

            INFO(NCCL_LOG_INFO,
                 "Testing rcclSetPxn for unsupported architecture GFX908");
            ...
            INFO(NCCL_LOG_INFO,
                 "PXN unsupported architecture GFX908 test completed - "
                 "pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
  ...
  // Register environment variable test
  ProcessIsolatedTestRunner::registerTest(
      ProcessIsolatedTestRunner::TestConfig(
          "PXN_WithEnvironmentVariable_Isolated",
          []() {
            INFO(NCCL_LOG_INFO, "Testing rcclSetPxn with NCCL_PXN_DISABLE "
            ...
            // Expected: RCCL_VALUE_INVALID when environment variable is already
            // set
            EXPECT_EQ(pxnDisable, RCCL_VALUE_INVALID)
                << "When NCCL_PXN_DISABLE is already set, pxnDisable should "
                   "remain RCCL_VALUE_INVALID";

            INFO(NCCL_LOG_INFO,
                 "PXN environment variable test completed - pxnDisable: %d",
                 pxnDisable);
            CleanupMockComm(mockComm);
          })
          .withEnvironment({{"NCCL_PXN_DISABLE", "1"}}));
