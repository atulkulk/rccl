...
TEST_F(ShmTests, ShmAllocateShareableBufferNullPointerChecks) {
  // Setup variables
  int tpProxyRank = 0;
  size_t size = 1024;
  bool legacy = true;
...
TEST_F(ShmTests, ShmImportShareableBufferNullPointerChecks) {
  // Setup variables
...
TEST_F(ShmTests, ShmSendProxySetup_FailPath) {
  // Setup variables
  struct ncclProxyConnection connection;
  memset(&connection, 0, sizeof(connection));
...
TEST_F(ShmTests, ShmRecvProxySetup_FailPath) {
  // Setup variables
  struct ncclProxyConnection connection;
  memset(&connection, 0, sizeof(connection));
