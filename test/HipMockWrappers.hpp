...
public:
  ...
  MOCK_METHOD(ncclResult_t, ncclStrongStreamWaitStream, (struct ncclStrongStream*, hipStream_t), ());
  MOCK_METHOD(ncclResult_t, ncclStrongStreamRelease, (struct ncclStrongStream*), ());
};
